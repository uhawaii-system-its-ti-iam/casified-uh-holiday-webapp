...
import HolidaysTableHeaders from '@/components/tables/holidays_table/table_element/holidays-table-headers';
import { Holiday } from './holiday';
import SortArrow from '@/components/tables/holidays_table/table_element/sort-arrow';
