...
In the 'tests' folder, we store test classes for our app's various components and pages, which can be found in the
...
You can also read about the React testing library here: https://testing-library.com/docs/react-testing-library/intro/
